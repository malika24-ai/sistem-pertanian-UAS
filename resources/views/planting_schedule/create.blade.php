    ...
    <div class="card shadow-lg p-3">
        <form action="{{ route('planting-schedule.store') }}" method="post" class="form">
            ...
            <div class="mb-3">
                ...
                <input class="form-control @error('estimated_harvest_date') is-invalid @enderror" type="date" id="estimated_harvest_date" name="estimated_harvest_date" required value="{{ old('estimated_harvest_date') }}">
