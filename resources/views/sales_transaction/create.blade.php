<x-app>
    ...
    <div class="card shadow-lg p-3">
        <form action="{{ route('sales-transaction.store') }}" method="post" class="form">
            @csrf
            ...
            <div class="mb-3">
                ...
                <input class="form-control @error('transaction_date') is-invalid @enderror" type="date" id="transaction_date" name="transaction_date" required value="{{ old('transaction_date') }}">
            ...
            <div class="mb-3">
                ...
                <input class="form-control @error('price') is-invalid @enderror" type="number" step="0.01" id="price" name="price" required value="{{ old('price') }}">
                @error('price')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
