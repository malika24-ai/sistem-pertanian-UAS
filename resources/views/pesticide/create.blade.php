<x-app>
    ...
    <div class="card shadow-lg p-3">
        <form action="{{ route('pesticide.store') }}" method="post" class="form">
            @csrf
            ...
            <div class="mb-3">
                <label for="name" class="form-label required">Nama Pestisida</label>
            ...
            <div class="mb-3">
                ...
                <input class="form-control @error('dosage') is-invalid @enderror" type="text" id="dosage" name="dosage" required value="{{ old('dosage') }}">
                @error('dosage')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input class="form-control @error('usage_date') is-invalid @enderror" type="date" id="usage_date" name="usage_date" required value="{{ old('usage_date') }}">
                @error('usage_date')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="text-end">
                <a href="{{ route('pesticide.index') }}" class="btn btn-warning me-1">Batal</a>
