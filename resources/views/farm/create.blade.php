<x-app>
    ...
    <div class="card shadow-lg p-3">
        <form action="{{ route('farm.store') }}" method="post" class="form">
            @csrf
            ...
            <div class="mb-3">
                ...
                <input class="form-control @error('location') is-invalid @enderror" type="text" id="location" name="location" required value="{{ old('location') }}">
                @error('location')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input class="form-control @error('area') is-invalid @enderror" type="number" step="0.01" id="area" name="area" required value="{{ old('area') }}">
                @error('area')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
